...
class ScanNetDataset(utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # image0, mask0, scale0 = read_scannet_gray(img_name0, resize=(640, 480), augment_fn=None)
        #                         #    augment_fn=np.random.choice([self.augment_fn, None], p=[0.5, 0.5]))
        # image1, mask1, scale1 = read_scannet_gray(img_name1, resize=(640, 480), augment_fn=None)
        #                         #    augment_fn=np.random.choice([self.augment_fn, None], p=[0.5, 0.5]))
